...
아래 표는 2026-08-22 이전 프로토콜의 역사 기록이다. 신규 `coverage-v2` 결과와 점수를
직접 비교하지 않는다. 첫 coverage-v2 실행을 새 기준선으로 삼는다.
...
Y1, D4, D5, Y2, Y3, Y4, B001, F001이 이 manifest를 사용했다. D1과 D3의 대표 평가는 32개
